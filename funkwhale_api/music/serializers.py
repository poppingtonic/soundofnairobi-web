...
class AlbumTrackSerializer(serializers.ModelSerializer):
    ...
    uploads = serializers.SerializerMethodField(read_only=True)
    listen_url = serializers.SerializerMethodField(read_only=True)
...
class UploadSerializer(serializers.ModelSerializer):
    track = TrackSerializer(required=False, allow_null=True, read_only=True)
